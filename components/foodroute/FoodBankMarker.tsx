...
export default function FoodBankMarker({ name, demandPct, waitMinutes, isRecommended }: FoodBankMarkerProps) {
  const color = getColor(demandPct);
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        <span className="text-white text-xs font-bold">{Math.round(demandPct)}%</span>
      </div>
