...
interface ProposedFoodBankPinProps {
  lat: number;
  lng: number;
}

export default function ProposedFoodBankPin({ lat, lng }: ProposedFoodBankPinProps) {
  return (
    <div className="flex items-center gap-2.5 px-3 py-2.5 bg-blue-50 border border-blue-200 rounded-lg">
      ...
      <div className="text-xs">
        <span className="font-bold text-blue-800">Proposed Site</span>
