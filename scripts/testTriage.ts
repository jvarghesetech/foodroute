/**
 * Test script for POST /api/foodroute/triage
...
async function main() {
  console.log('Sending test payload to', `${BASE_URL}/api/foodroute/triage`);
  console.log('Payload:', JSON.stringify(testPayload, null, 2));

  try {
    const res = await fetch(`${BASE_URL}/api/foodroute/triage`, {
      method: 'POST',
