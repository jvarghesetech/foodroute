...
const showcaseFeatures = [
  {
    label: 'Live Demand',
    title: 'Real-time food bank demand',
    description: 'Colored circles on every food bank show live demand. Green means capacity, red means overwhelmed.',
  },
  {
    label: 'Smart Routing',
    title: 'AI-powered needs & routing',
    description: 'Enter your needs, get an urgency score, and see the optimal food bank factoring in drive time, wait time, and language/dietary fit.',
  },
  {
    label: 'Site Simulation',
    title: 'Plan new food bank placement',
    description: 'Drop a proposed site, set capacity, run a Voronoi simulation. Watch client flow redistribute across the network.',
  },
];
    ...
    <div className="lp">
        ...
        >
          <motion.div variants={staggerItem}>
            <Link href="/" className="lp-nav-logo">
              <img src="/logo.png" alt="FoodRoute" className="lp-nav-logo-img" />
            </Link>
          </motion.div>
      ...
      <section ref={heroRef} className="lp-hero-section">
        ...
        <div className="lp-hero-content">
          ...
          >
            Smart food bank routing for Ontario
          </motion.p>
          <motion.div
        ...
        <div className="lp-statement">
          ...
          <FadeUp delay={0.1}>
            <p className="lp-stmt-small">
              1 in 8 households in Ontario face food insecurity.
            </p>
          </FadeUp>

          <FadeUp delay={0.2}>
            <div className="lp-stmt-block">
              <h2 className="lp-stmt-line">Ontario&apos;s food banks are stretched thin.</h2>
          ...
          <FadeUp delay={0.3}>
            <p className="lp-stmt-sub">
              Smarter placement. Faster routing. Shorter waits.
            </p>
          </FadeUp>
          ...
          >
            <div className="lp-browser-bar">
              ...
              <div className="lp-browser-url">
                ...
                <span>foodroute.ca/map</span>
              </div>
            </div>
            <div className="lp-browser-viewport">
              <iframe
                src="/map"
                title="FoodRoute Map Preview"
      ...
      <FadeUp>
        <footer className="lp-footer">
          <div className="lp-footer-inner">
            <span className="lp-footer-brand">FoodRoute</span>
            <span className="lp-footer-sep">&middot;</span>
            <a href="https://github.com/phintruong/ERoute" target="_blank" rel="noopener noreferrer">
              Source on GitHub
            </a>
            <span className="lp-footer-sep">&middot;</span>
            <span className="lp-footer-note">Built for JecHacks 2026</span>
          </div>
        </footer>
      </FadeUp>
    </div>
